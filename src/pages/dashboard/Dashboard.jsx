...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <section className="grid !mt-5 md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
          <div className="!py-5 font-semibold border-b border-gray-100">
          ...
          <div className="overflow-y-auto" style={{ maxHeight: "24rem" }}>
            <ul className="!p-6 space-y-6">
              <li className="flex items-center">
                ...
                <span style={{ marginLeft: "auto"}} className=" font-semibold">9.3</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 !mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img
                ...
                <span style={{ marginLeft: "auto"}} className=" font-semibold">8.9</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 !mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img
                ...
                <span style={{ marginLeft: "auto" }} className=" font-semibold">8.7</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 !mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img
                ...
                <span style={{ marginLeft: "auto"}} className="font-semibold">8.2</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 !mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img
              ...
              <li className="flex items-center">
                ...
                <span style={{ marginLeft: "auto",}} className="font-semibold">8.1</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 !mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img
                ...
                <span style={{ marginLeft: "auto",}} className="font-semibold">7.9</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 !mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img
                ...
                <span style={{ marginLeft: "auto", }} className=" font-semibold">7.7</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="text-center !mt-5 font-semibold text-gray-500">
